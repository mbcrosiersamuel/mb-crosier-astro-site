...
author: 'MB Crosier'
image:
    url: '/social-images/wedding-ai-cover.png'
...
<MDXStyles style="display: flex; gap: 16px; align-items: flex-start">
  <MDXStyles style="flex: 1; text-align: center">
    <img src={floralMidjourneyImg.src} alt="Bridesmaids in green dresses holding bright pinks and orange flowers" />
    <figcaption>Midjourney-generated inspiration</figcaption>
  </MDXStyles>
  <MDXStyles style="flex: 1; text-align: center">
    <img src={floralRealImg.src} alt="Bright pink, orange, and yellow flower bouquet on a table" />
    <figcaption>Real flowers from our design session</figcaption>
  </MDXStyles>
</MDXStyles>
...
<MDXStyles style="display: flex; gap: 16px; align-items: flex-start">
  <MDXStyles style="flex: 1; text-align: center">
    <img src={geminiImg.src} alt="Gemini welcome bag" />
    <figcaption>Gemini-generated</figcaption>
  </MDXStyles>
  <MDXStyles style="flex: 1; text-align: center">
    <img src={chatgptImg.src} alt="ChatGPT welcome bag" />
    <figcaption>ChatGPT-generated</figcaption>
  </MDXStyles>
</MDXStyles>
