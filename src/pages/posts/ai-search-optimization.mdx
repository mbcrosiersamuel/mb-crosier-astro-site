...
pubDate: 2025-03-03
description: 'Learnings on the current state of AI search optimization (or generative engine optimization (GEO), depending on who you ask).'
author: 'MB Crosier'
image:
    url: '/social-images/ai-seo.png'
    alt: 'Starting to get traffic from ChatGPT. How to do SEO for LLMs?'
type: 'Posts'
tags: ["Startups"]
---
