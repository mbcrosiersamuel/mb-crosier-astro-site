...
import zolaGiftReadyImg from '../../assets/zola/gift-ready-to-ship.png';
import starbucksBankImg from '../../assets/zola/starbucks-bank.png';
import starbucksStoredValueImg from '../../assets/zola/starbucks-stored-value.png';
import surpriseGiftImg from '../../assets/zola/surprise-gifts.png';
...
![$1.9B in stored value as of March 0225](starbucksStoredValueImg)
...
Here's an example gift, which right now is acting as a $39.99 deposit at Zola bank:

![I can 'send now' at any time to 'withdraw'](zolaGiftReadyImg)
...
![Surprise gifts, which are prepaid but won't be 'sendable' until wedding day](surpriseGiftImg)
